        ...
        <Fade bottom delay={600}>
          <div className={`mt-5 pt-2 ${isMobile ? 'w-100 px-3' : 'col-6'} mx-auto`}>
            <p className="text-white fs-f5 m-0">
              Enter the VetVault members area and start reaping the benefits, now! Be one of the first to get your hands on the new virtual VetCard, powered by Sentinel Digital*. To move up the line and get the chance to get a FREE VetCard* and other perks, just share the personal referral link we’ll give you when you register.
            </p>
